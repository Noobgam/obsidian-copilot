	...
	return (
		<div>
			...
			<p>QA mode relies a <em>local</em> vector index (experimental)
				<br/>
				OpenAI embeddings currently has the best retrieval quality. CohereAI embeddings are free during trial and are
				decent. With Huggingface Inference API, your mileage may vary.
			</p>
			<DropdownComponent
