  ...
  return (
    <div>
      ...
      <div className="warning-message">
        Please check the doc to set up LM Studio or Ollama server on your
        device.
      </div>
      <p>
        Local models can be limited in capabilities and may not work for some
        use cases at this time. Keep in mind that it is still in early
        experimental phase. But some 13B even 7B models are already quite
        capable!
      </p>
      <h3>LM Studio</h3>
      <p>
        ...
        <br />
        1. Start LM Studio server with CORS on. Default port is 1234 but if you
        change it, you can provide it below.
        <br />
        2. Pick LM Studio in the Copilot Chat model selection dropdown to chat
        with it!
      </p>
      <TextComponent
      ...
      <h3>Ollama</h3>
      <p>
        To use Local Copilot with Ollama, pick Ollama in the Copilot Chat model
        selection dropdown.
      </p>
